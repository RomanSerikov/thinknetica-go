...
var (
	...
	// PromQL: search_request_length_sum / search_requests_total
	searchRequestLength = promauto.NewHistogram(prometheus.HistogramOpts{
		Name:    "search_request_length",
		Help:    "Длина поискового запроса, байты.",
		Buckets: prometheus.LinearBuckets(10, 10, 20), // 20 корзин, начиная с 0, по 10 элементов
	})
)
...
func (s *Service) Search(w http.ResponseWriter, r *http.Request) {
	...
	searchRequestLength.Observe(float64(len(query)))
