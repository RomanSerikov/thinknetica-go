...
// PromQL: stored_documents_total
var storedDocumentsTotal = promauto.NewGauge(prometheus.GaugeOpts{
	Name: "stored_documents_total",
	Help: "Количество сохраненных документов.",
})
...
func (db *DB) StoreDocs(docs []crawler.Document) error {
	...
	storedDocumentsTotal.Add(float64(len(docs)))
